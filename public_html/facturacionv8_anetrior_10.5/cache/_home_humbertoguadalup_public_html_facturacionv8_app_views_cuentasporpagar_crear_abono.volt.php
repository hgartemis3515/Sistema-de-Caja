...
<!-- abonos - cobros -->
<div id="vm_crear_abono_deuda" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content" id="vm_crear_abono_deuda_content">
			...
			<div class="modal-body">
				<input type="hidden" name="vm_id_compra" id="vm_id_compra" value=""/>
