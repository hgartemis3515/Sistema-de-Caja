...
<div class="page-header">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Cuentas por Pagar</span></h4>
				...
				<div class="panel-body">
						...
						<form id="frm_filtros">
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="text" value='<?php echo date("d/m/Y", strtotime("-15 months")); ?>' class="form-control form-control-sm control_fecha_inicio" name="fecha_inicio" id="fecha_inicio">
									<input type="hidden" name="fecha_inicio_valor" value='<?php echo date("Y-m-d", strtotime("-15 months")); ?>' id="fecha_inicio_valor" />
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label class="label-form">
										<i class="icon-file-text2 position-left"></i>Selecciona un Proveedor:
									</label> 
									<select class="js-example-basic-single filtro_select" name="select_id_proveedor" id="select_id_proveedor">
							...
							<div class="col-md-2"> 
								<div class="form-group">
									...
									<select class="multiselect filtro_select" multiple="multiple" name="select_tipo_comprobante[]" id="select_tipo_comprobante" >
										...
										<option value="00">Otr.Docs.</option>
									</select>
								</div>
							</div>
						</form>
					...
					<div class="tabbable" id="tab_resumen_ig">
						<ul class="nav nav-tabs nav-tabs-highlight">
							<li class="active"><a href="#badges-tab1" data-toggle="tab" class="tab_opcion"><i class="icon-stats-growth mr-2"></i> Documentos de Compra</a></li>
						</ul>

						<div class="tab-content">
							<div class="tab-pane active" id="badges-tab1">
								<div class="col-md-12">
									<?= $this->partial('cuentasporpagar/cpe_sunat') ?>
								</div>
							</div>
						</div>
					</div>
...
<?= $this->partial('cuentasporpagar/crear_abono') ?>
<?= $this->partial('cuentasporpagar/lista_abonos') ?>