...
<div id="vista_validacion_container">
        ...
        <ul class="vista_validacion_checklist">
            <li class="<?php if ($validacion['tiene_sucursales_creadas']) { ?>vista_validacion_success<?php } else { ?>vista_validacion_error<?php } ?>">
                <div class="vista_validacion_icon">
                    <?php if ($validacion['tiene_sucursales_creadas']) { ?>✓<?php } else { ?>✕<?php } ?>
                </div>
                <span class="vista_validacion_text">
                    <?php if ($validacion['tiene_sucursales_creadas']) { ?>
            ...
            <li class="<?php if ($validacion['tiene_productos_creados']) { ?>vista_validacion_success<?php } else { ?>vista_validacion_error<?php } ?>">
                <div class="vista_validacion_icon">
                    <?php if ($validacion['tiene_productos_creados']) { ?>✓<?php } else { ?>✕<?php } ?>
                </div>
                <span class="vista_validacion_text">
                    <?php if ($validacion['tiene_productos_creados']) { ?>
            ...
            <li class="<?php if ($validacion['el_usuario_tiene_permisos_para_usar_pos']) { ?>vista_validacion_success<?php } else { ?>vista_validacion_error<?php } ?>">
                <div class="vista_validacion_icon">
                    <?php if ($validacion['el_usuario_tiene_permisos_para_usar_pos']) { ?>✓<?php } else { ?>✕<?php } ?>
                </div>
                <span class="vista_validacion_text">
                    <?php if ($validacion['el_usuario_tiene_permisos_para_usar_pos']) { ?>
            ...
            <li class="<?php if ($validacion['el_usuario_tiene_sucursal_asignada_activa']) { ?>vista_validacion_success<?php } else { ?>vista_validacion_error<?php } ?>">
                <div class="vista_validacion_icon">
                    <?php if ($validacion['el_usuario_tiene_sucursal_asignada_activa']) { ?>✓<?php } else { ?>✕<?php } ?>
                </div>
                <span class="vista_validacion_text">
                    <?php if ($validacion['el_usuario_tiene_sucursal_asignada_activa']) { ?>
        ...
        <div id="vista_validacion_steps">
            ...
            <ul>
                ...
                <?php if (!$esAdministrador && !$validacion['el_usuario_tiene_sucursal_asignada_activa']) { ?>
        ...
        <div id="vista_validacion_actions">
            <?php if ($esAdministrador) { ?>
                <a href="<?= $this->url->get('/facturacionv8/branchoffice/lista_sucursales') ?>" class="vista_validacion_button">Crear Sucursal</a>
                <a href="<?= $this->url->get('/facturacionv8/producto/listaproductos') ?>" class="vista_validacion_button">Agregar Producto</a>
            <?php } else { ?>
                <a href="<?= $this->url->get('/facturacionv8/dashboard') ?>" class="vista_validacion_button">Contactar al Administrador</a>
            <?php } ?>
        </div>
    </div>
