    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<?= $this->partial('documentoelectronico/ficha_reniec') ?>
            </div>
...
<!-- /Modal data cliente -->
<?= $this->partial('documentoelectronico/vm_agregar_item') ?>

<!-- Modal para msg guardado -->
<?= $this->partial('documentoelectronico/vm_msg_guardado') ?>

<!-- Modal para cuotas -->
<?= $this->partial('documentoelectronico/vm_lista_cuota') ?>
