...
<div class="page-header" style="position: relative; max-width: 1300px; margin: 0 auto; margin-top: 15px; margin-bottom: 15px;">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">SIRE - Ventas</span></h4>
		...
		<div class="col-md-12">
			<div class="panel" id="panel_criterios_busqueda">
				<div class="panel-body">
					...
					<div class="step-content stpe-ventas">
						<div class="step-items active step-1">
						
							<div class="single-step-box">
								<label class="label-form"><i class="icon-calendar position-left"></i>Paso 01: Selecciona el El Ejercicio y Periodo Tributario</label>
						...
						<div class="step-items step-2 disabled-items">
							<div class="single-step-box">
								...
								<div class="form-group has-feedback has-feedback-left">
									...
									<input type="text" class="form-control daterange-single mb-2"  value=""name="num_ticket" id="num_ticket" placeholder="Num Ticket" required>
									<div class="form-control-feedback">
										<i class="icon-calendar text-muted"></i>
									</div>
									<button type="button" id="btn_extraer_ticket_sire" target="_blank" class="btn bg-white font-weight-bold text-uppercase mt-2">
						...
						<div class="step-items step-3 disabled-items">
							...
							class="btn bg-white font-weight-bold text-uppercase">
		...
		<div class="col-md-12" id="content_reportes" style="margin-top: 25px; display:none;">
			<div class="panel">
				<div class="panel-heading">
					<h5 class="panel-title">Propuesta SIRE RVIE <a class="heading-elements-toggle"><i
					...
					<div class="breadcrumb-line breadcrumb-line-component mb-2">
						<ul class="breadcrumb">
							<li>
								...
								<span class="text-semibold">Estados SRVIE: </span>
							</li>
							<li id="inicio_lista"><img src="/facturacionv8/img/check_sire.png" style="width: 25px;"/> Validado</li>
							<li><img src="/facturacionv8/img/no_coincide_status.png" style="width: 25px;"/> No Coincide Estado</li>
							<li><img src="/facturacionv8/img/no_coincide_monto.png" style="width: 25px;"/> No Coincide Monto</li>
							<li><img src="/facturacionv8/img/no_existe_sunat.png" style="width: 25px;"/> No Existe el CPE en el Periodo Seleccionado</li>
						</ul>
					</div>
						...
						<div class="col-md-12">
							<div class="table-responsive p-20">
								<table class="table table-striped" id="tbl_propuesta_sire">
									<thead>
										<tr>
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">Análisis</th>

											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">CAR SUNAT</th>
											...
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" colspan="5">DATOS DE LA NOTA C/D</th>

											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">ID Proy.Operad.Atribuc.</th>
											
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" colspan="17">IMPORTES DE LA OPERACIÓN</th>
											
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">TIPO OPERACIÓN</th>
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">DAM / CP</th>
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">CLU</th>
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">ESTADO COMP.</th>

											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">¿Existe en Sire?</th>
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">¿Coincide Total?</th>
											<th style="border-top: 1px solid #e9eaea !important;" align="center" class="borde-cells" rowspan="2">¿Coincide Estado?</th>
										...
										<tr>
											...
											<th>Apellidos Nombres/Razón Social</th>
											...
											<th>Tipo CP/Doc.</th>
											<th>Serie del CDP</th>
											<th>Nro CP o Doc. Nro Inicial</th>
											<th>Nro Final</th>
											...
											<!-- <th>ID Proyecto Operadores Atribución</th> -->
