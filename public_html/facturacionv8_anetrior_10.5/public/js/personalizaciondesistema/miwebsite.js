...
function asignar_home(iduserpage) {
    swal({   
        ...
        if(isconfirmed) {
            $.ajax({
                url : '/facturacionv8/personalizaciondesistema/cambiar_home',
...
function eliminar_pagina(iduserpage) {
    swal({   
        ...
        if(isconfirmed) {
            $.ajax({
                url : '/facturacionv8/personalizaciondesistema/eliminar_pagina',
                data: {iduserpage: iduserpage},
                method :  'POST',
                dataType : "json"
            }).then(function(data){
...
function seleccionar_plantilla(id_plantilla) {
    swal({   
        ...
        if(isconfirmed) {
            $.ajax({
                url : '/facturacionv8/personalizaciondesistema/crear_nueva_pagina',
...
function get_paginas() {
	...
	$.ajax({
		url : '/facturacionv8/personalizaciondesistema/get_paginas',
        method :  'POST',
        dataType : "json"
    }).then(function(data){
		if(data.respuesta == 'ok') {
...
function guardar_data() {
    var light = $('#content_panel_personalizaciondesistema');
    $(light).block({
    message: '<div class="loading"> \
                <div class="loading-bar"></div> \
                <div class="loading-bar"></div> \
	...
	$.ajax({
		url : '/facturacionv8/personalizaciondesistema/guardar_data',
...
function get_lista_plantillas(idcategoria = 0) {
	...
	$.ajax({
		url : '/facturacionv8/personalizaciondesistema/get_templates',
