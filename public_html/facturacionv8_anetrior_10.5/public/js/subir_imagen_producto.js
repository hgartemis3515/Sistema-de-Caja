...
function inicializacion_plugin_para_recortar_imagenes_producto($preview, contenedorimagen, $botoncargarimagen, $botonguardarenservidor) {
...
function plugin_guardar_imagen_recortada() {
    ...
    $.ajax({
        ...
        url: "/facturacionv8/herramientas/guardar_imagen_producto",
        success: function(data) {
            ...
            if (data.respuesta == 'ok') {
                ...
                swal({
                    ...
                    function() {
						if(imagetipo == 'img_cuadrada') {
                            agregar_imagen_contenedor(data.urlimagen, $('#contenedor_imagenes_cuadradas'), $("#array_listaimagenes_cuadradas"), 'btn_eliminar_img_cuadrada', 'col-lg-2 col-md-2 col-sm-2 col-xs-6 content-box-1');
                        } else if(imagetipo == 'img_horizontal') {
                            agregar_imagen_contenedor(data.urlimagen, $('#contenedor_imagenes_horizontales'), $("#array_listaimagenes_horizontales"), 'btn_eliminar_img_horizontal', 'col-lg-3 col-md-3 col-sm-3 col-xs-12  content-box-2');
                        } else if(imagetipo == 'img_vertical') {
                            agregar_imagen_contenedor(data.urlimagen, $('#contenedor_imagenes_verticales'), $("#array_listaimagenes_verticales"), 'btn_eliminar_img_vertical', 'col-lg-3 col-md-3 col-sm-3 col-xs-6  content-box-3');
                        }
