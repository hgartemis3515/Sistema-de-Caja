$(function(){
	var php_editor_nota_credito = ace.edit("php_editor_nota_credito");
    php_editor_nota_credito.setTheme("ace/theme/monokai");
    php_editor_nota_credito.getSession().setMode("ace/mode/php");
    php_editor_nota_credito.setShowPrintMargin(false);

	var json_editor_nota_credito = ace.edit("json_editor_nota_credito");
    json_editor_nota_credito.setTheme("ace/theme/monokai");
    json_editor_nota_credito.getSession().setMode("ace/mode/json");
    json_editor_nota_credito.setShowPrintMargin(false);

	agregar_codigo_ejemplo_php_nota_credito(php_editor_nota_credito);
	agregar_codigo_ejemplo_json_nota_credito(json_editor_nota_credito)
});

function agregar_codigo_ejemplo_php_nota_credito(php_editor) {
    php_editor.setValue(
    `
	<?php
		...
		$data["cabecera_comprobante"] = array(
			...
			"doc_modifica_numero_comprobante" 			=> 17,
		...
		$ruta = "https://facturalaya.com/facturacionv8/api/procesar_notacredito";
...
function agregar_codigo_ejemplo_json_nota_credito(json_editor) {
