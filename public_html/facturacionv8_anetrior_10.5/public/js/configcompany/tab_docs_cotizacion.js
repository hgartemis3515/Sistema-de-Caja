$(function(){
	var php_editor_cotizacion = ace.edit("php_editor_cotizacion");
    php_editor_cotizacion.setTheme("ace/theme/monokai");
    php_editor_cotizacion.getSession().setMode("ace/mode/php");
    php_editor_cotizacion.setShowPrintMargin(false);

	var json_editor_cotizacion = ace.edit("json_editor_cotizacion");
    json_editor_cotizacion.setTheme("ace/theme/monokai");
    json_editor_cotizacion.getSession().setMode("ace/mode/json");
    json_editor_cotizacion.setShowPrintMargin(false);

	agregar_codigo_ejemplo_php_cotizacion(php_editor_cotizacion);
	agregar_codigo_ejemplo_json_cotizacion(json_editor_cotizacion)
});

function agregar_codigo_ejemplo_php_cotizacion(php_editor) {
    php_editor.setValue(
    `
    <?php
        ...
        $data["cabecera_comprobante"] = array(
            "tipo_documento"                => "88",  //{"77": NOTA DE VENTA}
            "moneda"                        => "PEN",  //{"USD", "PEN"}
        ...
        $ruta = "https://facturalaya.com/facturacionv8/api/procesar_cotizacion";
...
function agregar_codigo_ejemplo_json_cotizacion(json_editor) {
