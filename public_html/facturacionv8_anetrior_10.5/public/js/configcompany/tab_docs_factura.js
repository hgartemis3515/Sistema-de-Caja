$(function(){
	var php_editor_factura = ace.edit("php_editor_factura");
    php_editor_factura.setTheme("ace/theme/monokai");
    php_editor_factura.getSession().setMode("ace/mode/php");
    php_editor_factura.setShowPrintMargin(false);

	var json_editor_factura = ace.edit("json_editor_factura");
    json_editor_factura.setTheme("ace/theme/monokai");
    json_editor_factura.getSession().setMode("ace/mode/json");
    json_editor_factura.setShowPrintMargin(false);

	agregar_codigo_ejemplo_php_factura(php_editor_factura);
	agregar_codigo_ejemplo_json_factura(json_editor_factura)
});

function agregar_codigo_ejemplo_php_factura(php_editor) {
    php_editor.setValue(
    `
    <?php
...
function agregar_codigo_ejemplo_json_factura(json_editor) {
