$(function(){
	var php_editor_boleta = ace.edit("php_editor_boleta");
    php_editor_boleta.setTheme("ace/theme/monokai");
    php_editor_boleta.getSession().setMode("ace/mode/php");
    php_editor_boleta.setShowPrintMargin(false);

	var json_editor_boleta = ace.edit("json_editor_boleta");
    json_editor_boleta.setTheme("ace/theme/monokai");
    json_editor_boleta.getSession().setMode("ace/mode/json");
    json_editor_boleta.setShowPrintMargin(false);

	agregar_codigo_ejemplo_php_boleta(php_editor_boleta);
	agregar_codigo_ejemplo_json_boleta(json_editor_boleta)
});

function agregar_codigo_ejemplo_php_boleta(php_editor) {
    php_editor.setValue(
    `
    <?php
...
function agregar_codigo_ejemplo_json_boleta(json_editor) {
