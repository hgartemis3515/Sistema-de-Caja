...
.invoice-item__totals {
	text-align: center;
}
.invoice-item__totals .number {
	display: inline-block;
	min-width: 40px;
...
.invoice-item__totals button:first-child {
	padding: .5em 1.1em;
}
.invoice-item__totals button {
	padding: .5em 1em;
}
.pray-item_total {
	font-size: 17px;
			...
			<div class="row">
				<div class="col-md-12 mb-5">
					...
					<div class="input-group">
						...
						<input type="text" name="" id="" class="form-control" placeholder="Buscar productos">
						<span class="input-group-btn">
							<button class="btn bg-indigo legitRipple" type="button">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mt-5">
					<div class="thumbnail">			
						<div class="thumb">	
							<img src="/facturacionv8/img/product.jpg" alt="">
							<div class="item__dislike"><i class="icon-star-full2"></i></div>				
							<div class="caption-text">
								<p class="item__name">Producto 1</p>
								<p class="item__price">S/48.00</p>
							</div>		
						</div>
						<span class="item__quantity bg-indigo">1</span>		
					</div>
				</div>
				...
				<div class="sidebar-category sidebar-category-visible">
					<div class="category-content no-padding">
							...
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="select_tipo_doc">
										<select class="select2" name="opt_generales_tipodocelectronico" id="opt_generales_tipodocelectronico">
						...
						<ul class="navigation navigation-main navigation-accordion" id="sidebar_principal">
							<div class="content">
								<div class="flex-moneda">
									<div class="form-group">
										<label class="label-form">
											<i class="icon-cash2"></i> Moneda 
										</label>
								...
								<div class="row content_datos_cliente">
							...
							<div class="invoice-item__container">
								<div class="content__list-products">
									<div class="invoice-item__product">
										<div class="invoice-item__data"  data-toggle="modal" data-target="#modal_default">
											<p class="invoice-item__name">Producto prueba 01</p>
											<p class="invoice-item__price">S/18.00</p>
										</div>
										<div class="invoice-item__totals">
											<button class="btn bg-indigo">-</button>
											<p class="number">2</p>
											<button class="btn bg-indigo">+</button>
										</div> 
										<div class="item__totals">
											<span class="pray-item_total">S/36.00</span>
