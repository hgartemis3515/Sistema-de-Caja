...
<div class="page-header">
    <div class="page-header-content" style="max-width: 1120px;margin: 0 auto;">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Centro de
                    entrenamientoo</span></h4>
    ...
    <div class="row" style="max-width: 1120px;margin: 0 auto;">
        ...
        <div class="col-lg-12">
            <div class="alert bg-primary alert-styled-left">
                ...
                <span class="text-semibold">Bienvenido al Centro de Entrenamiento!</span> Aquí puedes descagar el manual
                de usuario de nuestro sistema: <a href="/files_pdf/guia_usuario_facturala_ya.pdf" target="_blank"
                    class="alert-link">Descargar manual</a>
            </div>
        </div>
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/q4TF_JBhJQ4">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_1.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                            </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/1_configurar_empresa_sucursal.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/UWKN0o2ZkoE">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_2.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                            ...
                            <div class="content-text-title">
                                <h6 class="font-weight-bold text-uppercase color-indigo">
                                    Cómo Agregar productos, importar productos, hacer traslados e ingresos de productos
                                    a Almacén
                                </h6>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/2_gestion_productos.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/1tEJkGVrQs4">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_3.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/auI7vzZFqhM">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_4.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/4_cuentas_bancarias.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/SZvlOm-jt_I">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_5.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/5_cambiar_usuario_contraseña.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/HzImJWnbhd0">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_6.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/6_boleta_sin_datos_cliente.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/aUpHAI602tM">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_7.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/B7BaqE1UudI">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_8.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/vcKgpLVetdA">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_9.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/9_factura_con_detraccion.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/VLNOOD_2Cmk">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_10.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                            ...
                            <div class="content-text-title">
                                <h6 class="font-weight-bold text-uppercase color-indigo">
                                    Cómo Ver el Último Precio Utilizado en la Venta de un Producto para un Cliente
                                    Antiguo
                                </h6>
                            </div>
                        </a>
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/10_ultimo_precio_utilizado.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/9wmiJZsqm-s">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_11.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/11_boleta_exportacion.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/IOutokmg2CM">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_12.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/12_factura_retencion.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/KqBrfukv80I">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_13.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/13_factura_con_cuotas_a_credito.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/GvSyNVk_7H8">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_14.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/14_orden_de_compra_cpe.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/80Ek1L73chU">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_15.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/15_numero_placa_cpe.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/n4HhFhY9mBc">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_16.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/16_cpe_fecha_anterior.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/eJVm_g6kID8">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_17.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/17_guia_remision_en_factura.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/C6mIJvvzOkI">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_18.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/18_agregar_ventas_a_vendendor.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/G5lv3f_BH-I">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_19.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/NdGGUc6GZ90">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_20.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/20_crear_cotizacion.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/4Wm_fyoMZ0I">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_21.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/21_crear_nota_credito.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/LhAlc8GTrp4">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_22.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/22_crear_nota_debito.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/tDFU1F1JfJw">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_23.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/23_como crear una guia de remision.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/WZNgx7ZzxwQ">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_24.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/24_importacion_cpe_en_excel.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/K-DOxKoJnnU">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_25.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/25_duplicar_documentos_cpe.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/UI37zS64iqU">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_26.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/26_enviar_documentos_whatsapp.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/ufaLaCEAi68">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_27.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                        ...
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/27_enviar_documentos_email.pdf"
                                target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                ...
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/9IWlrOwkX_A">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_28.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mt-5">
            <div class="panel border-top-indigo service-media-bx" style="max-width: 1120px;margin: 0 auto;">
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/Xho8L_7dZUM">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_29.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                            ...
                            <div class="content-text-title">
                                <h6 class="font-weight-bold text-uppercase color-indigo">
                                    Cómo Etiquetar Documentos Electrónicos
                                </h6>
                            </div>
                        </a>
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/29_agregar_etiquetas_comprobantes.pdf" target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                                    </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mt-5">
            <div class="panel border-top-indigo service-media-bx" style="max-width: 1120px;margin: 0 auto;">
                <div class="panel-body height-lg">
                    <div class="content-video">
                        <a class="modal-video mb-3" href="https://youtu.be/dH4uekCI-wE">
                            <div class="position-relative">
                                <img src="/facturacionv8/files_recursos/guia_videos/preview/plantilla_video_guia_30.jpg"
                                    class="position-relative img-fluid" alt="">
                                <div class="play-position-center">
                                    <img src="/facturacionv8/img/play_3.png">
                                </div>
                            ...
                            <div class="content-text-title">
                                <h6 class="font-weight-bold text-uppercase color-indigo">
                                    Cómo Cambiar Automáticamente los Precios de Venta al Registrar una Compra
                                </h6>
                            </div>
                        </a>
                        <div class="footer-panel">
                            <a href="/facturacionv8/files_recursos/guia_videos/pdf/30_cambiar_precios_venta.pdf" target="_blank">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                        Descargar PDF
                                    </div>
