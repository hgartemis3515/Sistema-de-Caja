...
<div class="content">
    ...
    <div class="row" id="modulo_personalizar_login">
        {{ partial('personalizaciondesistema/personalizar_login') }}
    </div>
    
    <div class="row" id="modulo_personalizar_registro" style="display:none;">
        {{ partial('personalizaciondesistema/personalizar_registro') }}
    </div>

    <div class="row" id="modulo_personalizar_dominio" style="display:none;">
        {{ partial('personalizaciondesistema/personalizar_dominio') }}
    </div>

    <div class="row" id="modulo_personalizar_colores" style="display:none;">
        {{ partial('personalizaciondesistema/personalizar_colores') }}
    </div>
