...
<div class="content" id="contenido_documentos_totales">
	...
	<div class="row">
				...
				<div class="panel-body">
					...
					<div class="col-md-2 opc_controles_avanzados">
						<div class="form-group">
							...
							<input type="text" value="<?php echo date('d-m-Y', strtotime('-30 days', strtotime(date('d-m-Y')))); ?>" class="form-control form-control-sm control_fecha_inicio" name="fecha_inicio" id="fecha_inicio">
							<input type="hidden" name="fecha_inicio_valor" value="<?php echo date('Y-m-d 00:00:00', strtotime('-30 days', strtotime(date('d-m-Y')))); ?>" id="fecha_inicio_valor" />
						</div>
					</div>
					...
					<div class="col-md-2 opc_controles_avanzados">
						<div class="form-group">
							...
							<input type="text" value="<?php echo date('d-m-Y 23:59:59'); ?>" class="form-control form-control-sm control_fecha_fin" name="fecha_fin" id="fecha_fin">
							<input type="hidden" name="fecha_fin_valor" value="<?php echo date('Y-m-d 23:59:59'); ?>" id="fecha_fin_valor" />
						</div>
					</div>
		...
		<div class="col-md-12" id="content_reportes" style="margin-top: 5px;">
			<div class="panel">
				<div class="panel-body">

					<div class="tabbable">
						<ul class="nav nav-xs nav-tabs nav-tabs-solid nav-tabs-component nav-justified" id="menu_tabs_estadisticas">
							<li class="active"><a href="#estadisticas_soles" data-toggle="tab"> Ventas en Soles</a></li>
							<li><a href="#estadisticas_dolares" data-toggle="tab"> Ventas en Dólares</a></li>
						</ul>

						<div class="tab-content">
							<div class="tab-pane active" id="estadisticas_soles">
							...
							<div class="tab-pane" id="estadisticas_dolares">
								<div class="row text-center">
									<div class="col-md-2 col-xs-6">
										<div class="content-group">
											<h5 class="text-semibold no-margin"><img src="/facturacionv8/img/factura.svg"
													style="width: 25px;"> <span id="html_total_facturas_dolares"></span></h5>
											<span class="text-muted text-size-small">Total con Facturas</span>
										</div>
									</div>
									...
									<div class="col-md-2 col-xs-6">
										<div class="content-group">
											<h5 class="text-semibold no-margin"><img src="/facturacionv8/img/boleta.svg"
													style="width: 25px;"> <span id="html_total_boletas_dolares"></span></h5>
											<span class="text-muted text-size-small">Total en Boletas</span>
										</div>
									</div>
									...
									<div class="col-md-2 col-xs-6">
										<div class="content-group">
											<h5 class="text-semibold no-margin text-danger"><img src="/facturacionv8/img/nota_credito.svg"
													style="width: 25px;"> - <span id="html_total_notas_credito_dolares"></span></h5>
											<span class="text-muted text-size-small">Total en Notas Crédito</span>
										</div>
									</div>
									...
									<div class="col-md-2 col-xs-6">
										<div class="content-group">
											<h5 class="text-semibold no-margin"><img src="/facturacionv8/img/nota_debito.svg"
													style="width: 25px;"> <span id="html_total_notas_debito_dolares"></span></h5>
											<span class="text-muted text-size-small">Total con Notas Débito</span>
										</div> 
									</div>
									...
									<div class="col-md-2 col-xs-6">
										<div class="content-group">
											<h5 class="text-semibold no-margin"><img src="/facturacionv8/img/nota_venta.svg"
													style="width: 25px;"> <span id="html_total_notas_venta_dolares"></span></h5>
											<span class="text-muted text-size-small">Total con Notas de Venta</span>
										</div>
									</div>
									...
									<div class="col-md-2 col-xs-6">
										<div class="content-group">
											<h5 class="text-semibold no-margin"><img src="/facturacionv8/img/money.svg"
													style="width: 25px;"> <span id="html_total_neto_dolares"></span></h5>
											<span class="text-muted text-size-small">Total Neto</span>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-8">
										<div style="height: 350px; width: 100%;" class="chart" id="grafico_ventas_detalle_dolares"></div>
									</div>
									<div class="col-md-4">
										<div style="height: 350px; width: 100%;" class="chart" id="grafico_tipos_venta_dolares"></div>
									</div>
								</div>
							</div>
						</div>
...
{{ partial('dashboard/modal_aviso') }}

{{ partial('dashboard/enviar_email') }}

{{ partial('cuentasporcobrar/lista_abonos') }}

{{ partial('dashboard/verificar_estado_sunat') }}

{{ partial('dashboard/modal_whatsapp') }}

{{ partial('dashboard/importar_cpe') }}

{{ partial('dashboard/modal_etiquetas') }}