                ...
                <div class="col-lg-7 col-sm-8 col-pad-0 align-self-center col-pad-0 align-self-center">
                    <div class="login-inner-form">
                        <div class="details">
                            ...
                            <h3 class="content-group">Iniciar Sesión</h3>
                            <form  class="frm_login" action="/facturacionv8/login/session" method="post">
                                ...
                                <div class="form-group">
                                    <input type="password" name="password" id="contrasena"  class="input-text" placeholder="Contraseña">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn-md btn-theme btn-block btn-login legitRipple" disabled>Acceder al Sistema <i class="icon-circle-right2 position-right"></i></button>
                                </div>
                            </form>
                            <div class="form-group">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-pad-0 bg-img align-self-center none-992">
                    ...
                    <ul class="social-list clearfix">
                        <?php 
                            ...
                            echo ' <li><a href="'.$patrocinador->url_facebook.'" target="_blank"><i class="fa fa-facebook"></i></a></li>';
                            } 
                            if(isset($patrocinador->url_youtube) && !empty($patrocinador->url_youtube)) { 
                            echo ' <li><a href="'.$patrocinador->url_youtube.'" target="_blank"><i class="fa fa-youtube"></i></a></li>';
                            } 
                            if(isset($patrocinador->url_twitter) && !empty($patrocinador->url_twitter)) { 
                            
                            echo ' <li><a href="'.$patrocinador->url_twitter.'" target="_blank"><i class="fa fa-twitter"></i></a></li>';
                            } 
                            if(isset($patrocinador->url_instagram) && !empty($patrocinador->url_instagram)) { 
                            echo ' <li><a href="'.$patrocinador->url_instagram.'" target="_blank"><i class="fa fa-instagram"></i></a></li>';
                            } 
                            if(isset($patrocinador->url_tiktok) && !empty($patrocinador->url_tiktok)) { 
                            echo ' <li><a href="'.$patrocinador->url_tiktok.'" target="_blank"> <img src="/facturacionv8/img/icons/tik-tok-white.png" width="15px" alt=""></a></li>';
                            } 
                        ?>
                    </ul>
                </div>
