...
.login-5 .login-box {
    ...
    background: rgba(0, 0, 0, 0.04) url(https://storage.googleapis.com/theme-vessel-items/checking-sites/logdy-html/HTML/main/assets/img/img-6.jpg) top left repeat;
                            ...
                            <div class="row form_content">
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn-md btn-theme float-left btn-login btn_cambiar_password legitRipple" disabled>Recuperar contraseña <i class="icon-circle-right2 position-right"></i></button>
                                    </div>
                                </div>
