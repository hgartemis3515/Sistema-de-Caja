				...
				<table class="'.$tb_pin.' mb-3" style="width:49%;margin-right:1.3em;float:left">
					<tbody>
						<tr>
							...
							<td width="140px"> 
								<img src="https://facturalaya.com'.$cpe['cabecera']['data_yape']['img_qr_yape'].'" alt="codigo-qr" class="pl-2" width="90px"> 
							</td>
							<td> 
				...
				<table class="'.$tb_yape.' mb-3" style="width:49%;">
					<tbody>
						<tr>
							...
							<td width="140px"> 
								<img src="https://facturalaya.com'.$cpe['cabecera']['data_plin']['img_qr_plin'].'" alt="codigo-qr"  class="pl-2" width="60px"> 
							</td>
							<td> 
					...
					<tbody>
						<tr>
							<td width="140px"> 
								...
								<img src="https://facturalaya.com'.$cpe['cabecera']['data_yape']['img_qr_yape'].'" alt="codigo-qr"  class="pl-2" width="60px"> 
							</td>
							<td> 
								<p class="font-weight-bold">Titular: '.$cpe['cabecera']['data_yape']['titular_yape'].'</p>
								<p class="font-weight-bold text-uppercase">N° de Telf: '.$cpe['cabecera']['data_yape']['celular_yape'].'</p>
					...
					<tbody>
						<tr>
							<td width="140px"> 
								...
								<img src="https://facturalaya.com'.$cpe['cabecera']['data_plin']['img_qr_plin'].'" alt="codigo-qr" class="pl-2" width="90px"> 
							</td>
							<td> 
								<p class="font-weight-bold">Titular: '.$cpe['cabecera']['data_plin']['titular_plin'].'</p>
								<p class="font-weight-bold text-uppercase">N° de Telf: '.$cpe['cabecera']['data_plin']['celular_plin'].'</p>
										...
										<tbody>
											<tr>
												<td width="90px"> 
													...
													<img src="https://facturalaya.com'.$cpe['cabecera']['data_yape']['img_qr_yape'].'" alt="codigo-qr"  class="pl-2" width="40px"> 
												</td>
												<td> 
													<p class="font-weight-bold text-uppercase">N° de Telf: '.$cpe['cabecera']['data_yape']['celular_yape'].'</p>
												</td>
										...
										<tbody>
											<tr>
												<td width="90px"> 
													...
													<img src="https://facturalaya.com'.$cpe['cabecera']['data_plin']['img_qr_plin'].'" alt="codigo-qr" class="pl-2" width="40px"> 
												</td>
												<td> 
													<p class="font-weight-bold">Titular: '.$cpe['cabecera']['data_plin']['titular_plin'].'</p>
													<p class="font-weight-bold text-uppercase">N° de Telf: '.$cpe['cabecera']['data_plin']['celular_plin'].'</p>
						...
						<tbody>
							<tr>
								<td width="140px"> 
									...
									<img src="https://facturalaya.com'.$cpe['cabecera']['data_yape']['img_qr_yape'].'" alt="codigo-qr"  class="pl-2" width="45px"> 
								</td>
								<td> 
									<p class="font-weight-bold">Titular:'.$cpe['cabecera']['data_yape']['titular_yape'].'</p>
									<p class="font-weight-bold">N° de Telf: '.$cpe['cabecera']['data_yape']['celular_yape'].'</p>
						...
						<tbody>
							<tr>
								<td width="140px"> 
									...
									<img src="https://facturalaya.com'.$cpe['cabecera']['data_plin']['img_qr_plin'].'" alt="codigo-qr" class="pl-2" width="45px"> 
								</td>
								<td> 
									<p class="font-weight-bold">Titular:'.$cpe['cabecera']['data_plin']['titular_plin'].'</p>
									<p class="font-weight-bold">N° de Telf: '.$cpe['cabecera']['data_plin']['celular_plin'].'</p>
					...
					<tbody>
						...
						if($cpe['cabecera']['data_yape']['mostrar_yape'] == 'si'){
							...
							<tr>
								...
								<td class="color-secundary"><img src="https://facturalaya.com'.$cpe['cabecera']['data_yape']['img_qr_yape'].'" alt="codigo-qr"  class="pl-2" width="60px"> </td>
							</tr>
							<tr>
						...
						if($cpe['cabecera']['data_plin']['mostrar_plin'] == 'si'){
							...
							<tr>
								...
								<td class="color-secundary">Código QR: </td>
								<td class="color-secundary"><img src="https://facturalaya.com'.$cpe['cabecera']['data_plin']['img_qr_plin'].'" alt="codigo-qr"  class="pl-2" width="60px"> </td>
							</tr>
							<tr>
								<td class="color-secundary">
									Datos:
