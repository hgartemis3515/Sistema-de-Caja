...
class SireventasController extends ControllerBase
{
	...
	public function txtReemplazarPropuestaRvieAction($num_ticket = '') {
		...
		$filename = "LE".$contribuyente->ruc.$sire_rvie->periodo_mes."00"."140400021112";
	...
	public function sireVentasGetTicketAction() {
		...
		if($request->isAjax() == true) 
		{
			...
			$sire_rvie = SireRvie::findFirst(array("id_contribuyente = :id_contribuyente: AND periodo_anio = :periodo_anio: AND periodo_mes = :periodo_mes:", 'bind' => array('id_contribuyente' => $usuario->id_contribuyente, 'periodo_anio' => $periodo_anio, 'periodo_mes' => $periodotributario), "order" => "fecha_registro DESC"));
