...
class TemplatecomprasController extends ControllerBase
{
	...
	public function get_html_otro_doc_ticket_1($cpe) {
		...
		<head>
			<meta charset="UTF-8">
			<meta name="viewport" content="width=device-width, initial-scale=1.0">
			<link rel="stylesheet" href="https://sistemantscompany.com/servicio-de-facturacion-electronica/fonts/flaticon/flaticon.css">
		...
		<style>
			...
			if($cpe['cabecera']['estado_documento'] == 'anulado') {
				...
				.masthead::before{
					...
					width: 100%;
					height: 800px;
					background-image: url(https://sistemantscompany.com/facturacionv8/img/anulado_pg_ticket.png);
				...
				body::before{
					...
					width: 100%;
					height: 100%;
					background-image: url(https://sistemantscompany.com/facturacionv8/img/reporte_plantilla/prueba_bg.png);
					z-index: -1;
				} ';
				...
				body::before{
					...
					width: 100%;
					height: 100%;
					background-image: url(https://sistemantscompany.com/facturacionv8/img/reporte_plantilla/anulado_pg_ticket_prueba.png);
					z-index: -1;
				} ';
			}
			$html = $html.'
