					...
					<tbody>
						...
						if($cpe['cabecera']['data_yape']['mostrar_yape'] == 'si'){
							...
							<tr>
								...
								<td class="color-secundary"><img src="https://facturalaya.com'.$cpe['cabecera']['data_yape']['img_qr_yape'].'" alt="codigo-qr"  class="pl-2" width="90px"> </td>
							</tr>
							<tr>
						...
						if($cpe['cabecera']['data_plin']['mostrar_plin'] == 'si'){
							...
							<tr>
								...
								<td class="color-secundary">Código QR: </td>
								<td class="color-secundary"><img src="https://facturalaya.com'.$cpe['cabecera']['data_plin']['img_qr_plin'].'" alt="codigo-qr"  class="pl-2" width="90px"> </td>
							</tr>
							<tr>
								<td class="color-secundary">
									Datos:
