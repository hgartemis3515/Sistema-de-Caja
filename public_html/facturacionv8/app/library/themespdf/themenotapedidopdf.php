<?php 
Class Themenotapedidopdf {
	public function get_html_notapedido($contribuyente, $cliente, $documento, $detalle, $sunatmoneda, $ruta_qr, $modo, $ubigeo, $data_patrocinador, $html_cuentas_corrientes, $condicion_pago, $vendedor, $sucursal) {
				...
				<tbody>
					<tr>
						...
						<td class="cabecera_documento">
							...
							<p style="font-weight: 600;">NOTA DE VENTA</p>
	...
	function get_html_notapedido_ticket($contribuyente, $cliente, $documento, $detalle, $sunatmoneda, $ruta_qr, $modo, $ubigeo, $data_patrocinador, $vendedor, $sucursal) {
		if($modo != 'prueba') {
			$ruta_base = '/home/humbertoguadalup/public_html';
		} else {
			$ruta_base = 'https://facturalahoy.com';
		...
		foreach($detalle as $item) {
			...
			<tr class="detalletable">
				<td class="texto_10_a" WIDTH="30">'.($item['CANTIDAD_DET'] + 0).'</td>
				<td class="texto_10_a" WIDTH="20">'.$item['DESCRIPCION_DET'].' - '.$item['UNIDAD_MEDIDA_NOMBRE'].'</td>
				<td class="texto_10_a" WIDTH="30">'.$sunatmoneda->simbolo.' '.$precio_unitario_item.'</td>
				<td class="texto_10_a" WIDTH="30">'.$sunatmoneda->simbolo.' '.custom_money_format($subtotal_item).'</td>
			</tr>
			';
		}
		...
		<body> 
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td align="center"  class="texto_14_bold">NOTA DE VENTA<td>
				</tr>
				<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					Representación Impresa de una Nota de Venta <br />
					CANJEAR ESTE TIPO DE DOCUMENTO POR UN DOCUMENTO ELECTRÓNICO
					<td>
				</tr>
				<tr>
					<td align="center" class="texto_10">
				...
				<tr>
					<td align="center" class="texto_10">'.$nota_documento.'</td>
				</tr>
				';
