<?php 
Class Themenotacreditopdf {
	public function get_html_notacredito($contribuyente, $cliente, $documento, $detalle, $sunatmoneda, $ruta_qr, $doc_modificado, $texto_motivo, $texto_doc_modificado, $modo, $ubigeo, $data_patrocinador, $html_cuentas_corrientes, $condicion_pago, $vendedor, $sucursal) {
		...
		$nombre_tipo_doc_cliente = 'Num.Doc.: ';
		if($cliente->id_tipodocidentidad == '1') {
			$nombre_tipo_doc_cliente = 'D.N.I.: ';
		} else if($cliente->id_tipodocidentidad == '6') {
			$nombre_tipo_doc_cliente = 'R.U.C.: ';
		}
				...
				<tbody>
					<tr>
						...
						<td class="cabecera_documento">
							...
							<p style="font-weight: 600;">NOTA DE CRÉDITO ELECTRÓNICA</p>
									...
									<tbody>
										...
										<tr>
											<td style="width:250px; font-family: Arial Narrow, Arial, sans-serif;" colspan="2">
												<strong>Motivo de Emisión:</strong> '.$texto_motivo.'<br />
												<strong>Documento Relacionado:</strong> '.$texto_doc_modificado.' '.$doc_modificado->serie_comprobante.'-'.$this->zero_fill($doc_modificado->numero_comprobante, 6).' | '.date("d-m-Y", strtotime($doc_modificado->fecha_comprobante)).'											
											</td>
										</tr>
										'.$aviso_texto_pruebas.'
									</tbody>
	...
	public function get_html_notacredito_ticket($contribuyente, $cliente, $documento, $detalle, $sunatmoneda, $ruta_qr, $doc_modificado, $texto_motivo, $texto_doc_modificado, $modo, $ubigeo, $data_patrocinador, $vendedor, $sucursal) {
		if($modo != 'prueba') {
			$ruta_base = '/home/humbertoguadalup/public_html';
		} else {
			$ruta_base = 'https://facturalahoy.com';
		...
		foreach($detalle as $item) {
			...
			<tr class="detalletable">
				...
				<td class="texto_11" WIDTH="70">'.$item['DESCRIPCION_DET'].'</td>
		...
		$nombre_tipo_doc_cliente = 'Num.Doc.: ';
		if($cliente->id_tipodocidentidad == '1') {
			$nombre_tipo_doc_cliente = 'Num. D.N.I.: ';
		} else if($cliente->id_tipodocidentidad == '6') {
			$nombre_tipo_doc_cliente = 'Num. R.U.C.: ';
		}
		...
		<body> 
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				$html = $html.'
				<tr>
					<td align="center" class="texto_12">'.$sucursal->txt_pdf_ticket_1.'<td>
				</tr>';
				}
				...
				<tr>
					<td align="center"  class="texto_14_bold">NOTA DE CRÉDITO ELECTRÓNICA<td>
				</tr>
				<tr>
				...
				<tr>
					<td  class="texto_12">
						Motivo de Emisión: '.$texto_motivo.'<br />
						Documento Relacionado:<br /> '.$texto_doc_modificado.' '.$doc_modificado->serie_comprobante.'-'.$this->zero_fill($doc_modificado->numero_comprobante, 6).' | '.date("d-m-Y", strtotime($doc_modificado->fecha_comprobante)).'											
					</td>
				</tr>
				<tr>
					<td class="texto_12">
				...
				<tr>
					<td class="texto_12">'.$nombre_tipo_doc_cliente.$cliente->num_doc.'<td>
				</tr>
				<tr>
					<td class="texto_12">Direc.: '.$direccion_fiscal.'<td>
				</tr>
				'.$nro_placa.'
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				$html = $html.'
				<tr>
					<td align="center" class="texto_10">'.$sucursal->txt_pdf_ticket_2.'<td>
				</tr>';
				}
				...
				$html = $html.'
				<tr>
					<td align="center" class="texto_10">'.$sucursal->txt_pdf_ticket_3.'<td>
				</tr>';
				}
