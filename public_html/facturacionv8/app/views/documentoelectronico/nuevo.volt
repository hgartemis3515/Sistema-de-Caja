			...
			<div class="panel" style="max-width: 1100px; margin: 0 auto;">
				...
				<div class="panel-body" id="cuerpo_comprobante" style="padding-top: 0px !important;">
					<form action="" method="post" name="frm_documentoelectronico" id="frm_documentoelectronico" class="frm_documentoelectronico">
						...
						<div class="row" id="grupo_opciones_avanzadas" style="display: none;">
							...
							<div class="form-group col-md-3 col-xs-6">
								<label><i class="icon-calendar2 position-left"></i> Fecha.Venc.:</label>
								<input type="text" name="fecha_vence_comprobante" id="fecha_vence_comprobante" placeholder="" class="form-control control_fecha">
							</div>
							<div class="form-group col-md-3 col-xs-12">
							...
							<div class="form-group col-md-3 col-xs-12">
								<label><i class="icon-file-text2 position-left"></i> N° Placa Vehículo:</label>
								<input type="text" name="nro_placa_vehiculo" id="nro_placa_vehiculo" placeholder="Número Placa" value="" class="form-control">
							</div>

							<div class="form-group col-md-3 col-xs-12">
								<label><i class="icon-file-text2 position-left"></i> N° de Orden:</label>
								<input type="text" name="nro_orden" id="nro_orden" placeholder="Número de Orden" value="" class="form-control">
							</div>

							<div class="form-group col-md-3 col-xs-12" id="lista_guias_cliente" style="display: none;">
								<div class="has-feedback has-feedback-left">
									<label><i class="icon-profile position-left"></i>Guia de Remisión Electrónica </label>
							...
							<div class="form-group col-md-3 col-xs-12">
								<label><i class="icon-file-text2 position-left"></i> Guía Remisión (Manual):</label>
						...
						<div class="row" id="contenido_nota_credito_debito" style="display:none;">
							...
							<div class="form-group col-md-4 data_no_modificable_notas">
								...
								<div style="overflow: hidden; padding-right: .5em;">
									<label><i class="icon-barcode2 position-left"></i>Serie y Número de Doc.Elect.:<span class="text-danger">*</span></label>
							...
							<div class="form-group col-md-5" id="contenido_motivo_nota_credito">
								<label><i class="icon-file-text2 position-left"></i>Motivo:<span class="text-danger">*</span></label>
						...
						<div class="row">
							...
							<div class="col-md-4" id="razonsocial_numerodocumento">
								<div class="form-group">
									...
									<input type="text" title="Ingresa la Razón Social o Nombre" name="cliente_nombre" id="cliente_nombre" placeholder="Nombre o Razón Social Aquí" class="form-control cliente_nombre"  required>
								</div> 
							</div>
							...
							<div class="col-md-6 content_email_cliente" style="display: none;">
								<div class="form-group">
									<label><i class="icon-envelop2 position-left"></i> Email: <span class="text-danger">*</span></label>
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-lg-7">
									<div class="row">
										<div class="col-lg-6 col-sm-12 col-md-12"  id="content_descuento_porcentaje">
											<div class="form-group">
										...
										<div class="col-lg-6 col-sm-12 col-md-12" id="content_condicionpago_comprobante">
											<div class="form-group">
												<div class="has-feedback has-feedback-left">
						...
						<div class="row">
							...
							<div class="col-md-12 text-center" style="padding-bottom: 25px;">
								<button id="btn_guardar_doc_electronico" type="button" class="btn btn-primary btn-labeled btn-xs legitRipple text-uppercase font-weight-bold"><b><i class="icon-floppy-disk"></i></b> Guardar Documento Electrónico</button>
							</div>
						</div>
					</form>
				</div>
			...
			<div class="panel-heading bg-indigo-400">
				...
				<div class="heading-elements">
					<form class="heading-form" action="#">
						<div class="form-group">
							<a href="/facturacionv8/producto" target="_blank" class="btn bg-primary font-weight-bold text-uppercase">
				...
				<form action="#" id="frm_producto" method="get" accept-charset="utf-8">
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="producto_tipo_afect_igv"><i class="icon-percent position-left"></i>Tipo Afectación IGV</label>
						...
						<div class="form-group col-md-3">
							...
							<select class="form-control valid" name="producto_unidadmedida" id="producto_unidadmedida" disabled>
								
							</select>
						</div>
						<div class="form-group col-md-12">
							<label for="producto_descripcion"><i class="icon-file-text position-left"></i> Descripcion</label>
							<input type="text" class="form-control" value="" name="producto_descripcion" id="producto_descripcion">
						</div>
						<div class="form-group col-md-4" id="content_preciounidad_inc_igv">
							<label for="producto_preciounidad"><span id="text_precio_inc_igv">Precio/Uni(Inc.IGV)</span> <span class="simbolo_moneda">S/.</span></label>
							<div class="input-group">
								<span class="input-group-addon font-weight-bold simbolo_moneda">S/.</span>
								<input class="form-control totales_input" type="number" inputmode="numeric" pattern="[0-9]*" value="" name="producto_preciounidad" id="producto_preciounidad">
							</div>
						</div>
						<div class="form-group col-md-4" id="content_preciounidad_sin_igv">
							<label for="producto_preciounidad_sin_igv"><span id="text_precio_sin_igv">Precio/Uni(Sin.IGV)</span> <span class="simbolo_moneda">S/.</span></label>
							<div class="input-group">
								<span class="input-group-addon font-weight-bold simbolo_moneda">S/.</span>
								<input class="form-control totales_input" type="number" inputmode="numeric" pattern="[0-9]*" value="" name="producto_preciounidad_sin_igv" id="producto_preciounidad_sin_igv">
							</div>
						</div>
						<div class="form-group col-md-4">
							<label for="producto_cantidad"><i class="icon-stack position-left"></i>Cantidad</label> 
							<input class="form-control totales_input" type="number" inputmode="numeric" pattern="[0-9]*" value="1" name="producto_cantidad" id="producto_cantidad">
						</div>
						<div class="form-group col-md-4">
							<label for="producto_subtotal">Sub.Total <span class="simbolo_moneda">S/.</span></label>
							<div class="input-group">
								<span class="input-group-addon font-weight-bold simbolo_moneda">S/.</span>
						...
						<div class="form-group col-md-4">
							<label for="producto_igv">IGV (18%) <span class="simbolo_moneda">S/.</span></label>
							<div class="input-group">
								<span class="input-group-addon font-weight-bold simbolo_moneda">S/.</span>
						...
						<div class="form-group col-md-4">
							<label for="producto_total">Total <span class="simbolo_moneda">S/.</span></label>
							<div class="input-group">
								<span class="input-group-addon font-weight-bold simbolo_moneda">S/.</span>
