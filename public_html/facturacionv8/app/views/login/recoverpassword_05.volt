...
.login-5 .login-box {
    ...
    background: rgba(0, 0, 0, 0.04) url(https://nimoy.ceosdesigns.sk/template/v07/images/smBackground.jpg) top left repeat;
                            ...
                            <div class="row form_content">
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn bg-indigo  btn-login btn_cambiar_password legitRipple" disabled>Recuperar contraseña <i class="icon-circle-right2 position-right"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="row social nm-mb-1">
                                    <div class="col-md-6 mb-2 mb-md-0  mt-5">
