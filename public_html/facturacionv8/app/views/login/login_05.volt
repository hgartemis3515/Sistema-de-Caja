                                ...
                                <div class="row form_content">
                                    ...
                                    <div class="col-md-12" style="margin-top: 15px;">
                                        <div class="text-center sign-up">
                                            ...
                                            ?>
                                            <span class="ftz-17">Al Utilizar Nuestros Servicios Aceptas Nuestros <a href="/facturacionv8/terminoslegales/terminos_del_servicio" target="_blank">Términos y Condiciones y Política de Tratamiento de Datos.</a></span>
                                            <?php
                                            } else {
                                            ?>
                                            <span class="ftz-17">Al Utilizar Nuestros Servicios Aceptas Nuestros <a href="<?php echo $data_empresa['url_terminos_condiciones']; ?>" target="_blank">Términos y Condiciones</a> y <a href="<?php echo $data_empresa['url_politica_privacidad']; ?>" target="_blank">Nuestra Política de Privacidad</a></span>
                                            <?php
                                            }
                                            ?>
                                        </div>
                                    ...
                                    <div class="col-md-12 mb-5">
                                        <div class="text-center sign-up">
                                            <span>¿No tienes cuenta? <a href="/facturacionv8/registro" target="_blank">Regístrate</a></span>
                                        </div>
                                    </div>
