...
<form name="frm_nuevo_producto" id="frm_nuevo_producto" action="">
	<div class="row justify-content-end" style="display: none;">
		<input type="hidden" class="form-control form-control-sm" name="idproducto_newprod" id="idproducto_newprod">
			...
			<div class="col-md-4  align-self-end col-xs-4">
				<div class="radio">
					<label>
						<input type="radio" value="01" name="tipo_producto" class="control-primary" checked="checked">
			...
			<div class="col-md-4 align-self-end col-xs-4">
				<div class="radio">
					<label>
						<input type="radio" value="02" name="tipo_producto" class="control-success">
						Registrar un servicio
					</label>
				</div>
			</div>
	</div> 
	<div class="row" id="contenido_nuevo_producto">
		...
		<div class="col-md-3 col-xs-6" id="content_preciounidad_inc_igv">
			<div class="form-group">
				<label for="nuevo_producto_valor_con_igv">PrecioVenta(Inc.IGV)</label>
				<div class="input-group">
					<span class="input-group-addon font-weight-bold simbolo_moneda_nuevoproducto">S/.</span>
					<input type="number" value="0" class="form-control form-control-sm new_prod_inputs_selected" name="nuevo_producto_valor_con_igv" id="nuevo_producto_valor_con_igv" placeholder="Valor Unitario (Con IGV)">
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 col-xs-6" id="content_preciounidad_sin_igv">
			<div class="form-group">
				<label for="producto_total">PrecioVenta(Sin IGV)</label>
				<div class="input-group">
					<span class="input-group-addon font-weight-bold simbolo_moneda_nuevoproducto">S/.</span>
					<input type="number" value="0" class="form-control form-control-sm new_prod_inputs_selected" name="nuevo_producto_valor_sin_igv" id="nuevo_producto_valor_sin_igv" placeholder="Valor Unitario (Sin IGV)">
				</div>
			</div>
		</div>
		...
		<div class="col-md-6 col-xs-6" id="content_categoria">
		...
		<div class="col-md-6 col-xs-6" id="content_unidad_medida">
			<div class="form-group">
				<label class="label-form">
					<i class="icon-stairs-up position-left"></i> Unidad de Medida <span class="text-danger">*</span>
				</label>
				<select class="id_unidad_medida select_with_search" name="nuevo_producto_unidad" id="nuevo_producto_unidad">
				</select>
			</div>
		</div>
		
		
		<div <?php if($precio_venta_minimo == 'si'){echo " class='col-md-4 col-xs-6'"; } else {echo " class='col-md-3 col-xs-6'"; } ?>>
			<div class="form-group">
				<label class="label-form">
					<i class="icon-stack position-left"></i> Stock Inicial <span class="text-danger">*</span>
				</label>
				<input type="number" value="0" class="form-control form-control-sm new_prod_inputs_selected" name="nuevo_producto_stock" id="nuevo_producto_stock" placeholder="Stock Actual"> 
			</div>
		</div>
		<div <?php if($precio_venta_minimo == 'si'){echo " class='col-md-4 col-xs-6'"; } else {echo " class='col-md-3 col-xs-6'"; } ?>>
			<div class="form-group">
				...
				<input type="number" value="0" class="form-control form-control-sm new_prod_inputs_selected" name="nuevo_producto_stock_minimo" id="nuevo_producto_stock_minimo" placeholder="Stock Mínimo"> 
			</div>
		</div>
		...
		<div <?php if($precio_venta_minimo == 'si'){echo " class='col-md-4 col-xs-6'"; } else {echo " class='col-md-3 col-xs-6'"; } ?>>
			<div class="form-group">
				<label class="label-form">
					<i class="icon-stack position-left"></i>P.Comp.Inc.IGV<span class="text-danger">*</span>
				</label>
				<div class="input-group">
					<span class="input-group-addon font-weight-bold simbolo_moneda_nuevoproducto">S/.</span>
					<input type="number" value="0" class="form-control form-control-sm new_prod_inputs_selected" name="nuevo_producto_precio_compra" id="nuevo_producto_precio_compra" placeholder="Precio de Compra">
				</div>
			</div>
		</div>
		...
		<div class='col-md-4 col-xs-6' <?php if($precio_venta_minimo != 'si'){echo "style='display: none;'"; } ?>>
			<div class="form-group">
				<label class="label-form">
					<i class="icon-percent position-left"></i> % G. Mínima:
				</label>
		...
		<div <?php if($precio_venta_minimo == 'si'){echo " class='col-md-4 col-xs-6'"; } else {echo " class='col-md-3 col-xs-6'"; } ?>>
			<div class="form-group">
				<label class="label-form">
					<i class="icon-percent position-left"></i> % G. Máxima:
				</label>
				<div class="input-group" id="content_ganancia_maxima">
					<span class="input-group-addon font-weight-bold simbolo_descuento">% </span>
					<input type="text" value="0" title="Ingresa el Porcentaje de Ganancia Máxima" name="txt_porcentaje_ganancia_maxima" id="txt_porcentaje_ganancia_maxima" placeholder="Porcentaje Ganancia Mínima" class="form-control input_modify_totales txt_porcentaje_ganancia_maxima">
				</div>
			</div>
		</div>
		...
		<div class="col-md-2 col-xs-6">
			<div class="form-group">
				...
				<div class="checkbox checkbox-switch" style="padding: 0;">
					<label>
