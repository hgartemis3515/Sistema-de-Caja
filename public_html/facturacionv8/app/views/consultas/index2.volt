...
.page-container {
    background-image: url(/facturacionv8/img/1.jpg);
            ...
            <div class="content-wrapper">
                <div class="content" id="contenido_form_busqueda">
                    ...
                    <div class="panel panel-body login-form">
                        <div class="text-center">
                            <a href="/facturacionv8/login"><a href="#" target="_blank"><img src="<?php echo $data_empresa['logo_img_461']; ?>" class="logo" width="300px" alt=""></a>
                        </div>                        
