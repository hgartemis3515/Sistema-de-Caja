...
<div class="page-header">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Documento eléctronico: Nota de Crédito</span></h4>
		</div>
		...
		<div class="col-lg-12 col-md-12">
			<div class="page-header page-header-light" style="border-top: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd;">
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<form name="frm_notacredito" id="frm_notacredito" action="">
							...
							<div class="row">
								...
								<div class="col-lg-3 col-sm-6 col-md-6">
									<div class="form-group">
										...
										<input name="num_notacredito" id="num_notacredito" type="text" class="form-control" value="01">
									</div>
								</div>
								<div class="col-lg-3 col-sm-6 col-md-6">
									<div class="form-group">
								...
								<div class="panel-body">
									<div class="tabbable">
										<ul class="nav nav-tabs nav-tabs-highlight">
											<li class="active"><a href="#detalle_notacredito" data-toggle="tab" class="legitRipple">Detalle</a></li>
											<li><a href="#guia_emision" data-toggle="tab" class="legitRipple">Guía de Remisión</a></li>
										</ul>
										<div class="tab-content">
											<div class="tab-pane active" id="detalle_notacredito">
