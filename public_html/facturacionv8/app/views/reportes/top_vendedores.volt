...
<div class="page-header">
	<div class="page-header-content" style="max-width: 1120px;margin: 0 auto;">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Reporte Top Vendedores</span></h4>
	...
	<div class="row">
		<div class="col-md-12 col-md-12">
			<div class="panel border-top-indigo" style="max-width: 1120px;margin: 0 auto;">
				<div class="panel-body" id="content_panel_topvendedores">
                    ...
                    <form name="frm_reporte_top_vendedores" id="frm_reporte_top_vendedores" action="">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="numero_registros" id="numero_registros">
                                        <option selected value="100">Top 100 Vendedores</option>
                                        <option value="10">Top 10 Vendedores</option>
                                        <option value="20">Top 20 Vendedores</option>
                                        <option value="30">Top 30 Vendedores</option>
                                        <option value="50">Top 50 Vendedores</option>
                                        <option value="200">Top 200 Vendedores</option>
                                        <option value="500">Top 500 Vendedores</option>
                                        <option value="1000">Top 1000 Vendedores</option>
                            ...
                            <div class="col-lg-12">
                                <div class="text-right">
                                    <button class="btn bg-indigo legitRipple btn_generar_reporte_topvendedores" type="button">
                                        Generar
                                    </button>
                                </div>
                            </div>
			...
			<div class="panel border-top-indigo"  style="max-width: 1120px;margin: 0 auto;">
				<div class="panel-body"  id="content_list_vendedores">
					<fieldset class="content-group">
						<legend class="text-bold">
							<i class="icon-pencil5 mr-2" aria-hidden="true"></i>
							<span class="font-weight-bold text-uppercase">Lista de Top Vendedores</span>
						</legend>
					</fieldset>
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
							<table class="table" id="tbl_list_vendedores">
								<thead>
                                    <tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                ...
                                Nombre Colaborador: </span>
                                <span class="text-uppercase font-weight-700" id="info_nombre_vendedor"></span>
                            </p>
                        </div>
                        <div class="col-lg-6">
                            <p>
                                <span class="label-form"><i class="icon-user position-left"></i>
                                <span id="vm_tipo_doc_identidad">Email: </span></span>
                                <span class="text-uppercase font-weight-700" id="info_email_vendedor"></span>
                            </p>
                        </div>
                        <div class="col-lg-6">
                            <p>
                                <span class="label-form"><i class="icon-user position-left"></i>
                                Código</span>
                                <span class="text-uppercase font-weight-700" id="info_celular_vendedor"></span>
                            </p>
                        </div>
                        <div class="col-lg-12">
                            <p>
