...
<head>
    ...
    {{ stylesheet_link("template/assets/css/icons/icomoon/styles.css") }}
    {{ stylesheet_link("template_new/global_assets/css/icons/fontawesome/styles.min.css") }}
    {{ stylesheet_link("template/assets/css/bootstrap.css") }}
    {{ stylesheet_link("template/assets/css/core.css") }}
    {{ stylesheet_link("template/assets/css/components.css") }}
    {{ stylesheet_link("template/assets/css/colors.css") }}
	<!-- /global stylesheets -->
    
    <!-- Core JS files -->
    {{ javascript_include("template/assets/js/plugins/loaders/pace.min.js") }}
    {{ javascript_include("template/assets/js/core/libraries/jquery.min.js") }}
    {{ javascript_include("template/assets/js/core/libraries/bootstrap.min.js") }}
    {{ javascript_include("template/assets/js/plugins/loaders/blockui.min.js") }}
    {{ javascript_include("template/assets/js/plugins/notifications/sweet_alert.min.js") }}
    <!-- /core JS files -->
