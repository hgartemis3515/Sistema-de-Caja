    ...
    public function getListaUsuariosAction() {
        ...
        if($request->isAjax() == true) 
        {
            ...
            while($fila = $sentencia->fetch()) {
                ...
                $herramientas = new HerramientasController;
                $cadena_encriptada = $herramientas->encriptar('FACTURALAYAAAAA||'.$item->idusuario);
                $url_login = '<a target="_blank" href="/facturacionv8/login/inicio_sesion_remoto?user='.$cadena_encriptada.'">Enlace Login</a>';
                ...
                <div class="media-body">
                    ...
                    <div class="text-muted text-size-small"><span class="status-mark border-danger position-left"></span> '.$url_login.'</div>
                </div>
                ';
