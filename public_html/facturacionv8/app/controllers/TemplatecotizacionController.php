<?php
class TemplatecotizacionController extends ListaplantillaspdfController
{
		...
		<body>
			...
			<!--<div class="resumen_totales">
				<div class="col-7">
					...
					<p class="mb-1 mt-3"><span class="font-weight-bold">Consulte su documento electrónico en:</span> '.$ruta_consulta_documento.'</p>
				...
				<div class="col-5 float-right">
					<table class="tb_resumen_totales float-right">
						<tbody>
							<tr>
								<td class="font-weight-bold text-uppercase">Resumen:</td>
							</tr>
							'.$resumen.'
						</tbody>
					</table>
	...
	public function get_html_plantilla_a4_3($data) {
		...
		//Ubicación
		$direccion_fiscal = ($cliente->direccion_fiscal == '')?'<p><span class="text-primary font-weight-bold">Dirección:</span> - </p>':'<p><span class="text-primary font-weight-bold">Dirección:</span> '.$cliente->direccion_fiscal.'</p>';
		...
		foreach($detalle as $item) {
			...
			<tr style="border: none !important;">
				<td>'.($item['CANTIDAD_DET'] + 0).'</td>
				<td style="text-align: left !important;">'.nl2br($item['DESCRIPCION_DET']).'</td>
				<td style="text-align: right !important;">'.$sunatmoneda->simbolo.' '.$precio_unitario_item.'</td>
				<td>'.$item['UNIDAD_MEDIDA_NOMBRE'].'</td>
				<td>'.$text_afectacion.'</td>
				<td style="text-align: right !important;">'.$sunatmoneda->simbolo.' '.custom_money_format($subtotal_item).'</td>
			</tr>
        ...
        if($documento->id_codigomoneda == 'USD') {
			$resumen = $resumen.'
			<tr>
				<td class="text-primary text-right">T.C. ('.$documento->tipo_cambio_sunat.'): </td>
				<td  class="text-right">>
		...
		foreach($lista_cuentas as $cuenta) {
			...
			//Icon de banco 
			if(strtolower($cuenta->nombre_banco) == 'bcp' || strtolower($cuenta->nombre_banco) == 'bcp peru' || strtolower($cuenta->nombre_banco) == 'banco de credito del peru' || strtolower($cuenta->nombre_banco) == 'banco de credito' || strtolower($cuenta->nombre_banco) == 'banco de crédito bcp'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/logobcp.jpg" width="50" class="mr-2 mb-1">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'interbank' || strtolower($cuenta->nombre_banco) == 'banco interbank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/interbank.jpg" width="50" class="mr-2 mb-1">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'bbva' || strtolower($cuenta->nombre_banco) == 'BBVA CONTINENTAL' || strtolower($cuenta->nombre_banco) == 'bbva - banco continental' || strtolower($cuenta->nombre_banco) == 'banco bbva'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bbva.jpg" width="50" class="mr-2 mb-1">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'banco de la nacion' || strtolower($cuenta->nombre_banco) == 'nacion' || strtolower($cuenta->nombre_banco) == 'banco de la nación' || strtolower($cuenta->nombre_banco) == 'banco nación'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bc_nacion.jpg" width="50" class="mr-2 mb-1">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'scotiabank' || strtolower($cuenta->nombre_banco) == 'banco scotiabank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/scotiabank.png" width="50" class="mr-2 mb-1">
				';
			}
			

			$html_cuentas_corrientes = $html_cuentas_corrientes.'
			<div class="col-4 p-0 m-0" style="height: 90px">
		...
		<body>
			...
			<footer class="w-100" style="border-top:  1px solid #dddddd;">
				'.$html_cuentas_corrientes.'
			</footer>
		</body>
		</html>
	...
	public function get_html_plantilla_a4_4($data) {
		...
		foreach($lista_cuentas as $cuenta) {
			...
			//Icon de banco 
			if(strtolower($cuenta->nombre_banco) == 'bcp' || strtolower($cuenta->nombre_banco) == 'bcp peru' || strtolower($cuenta->nombre_banco) == 'banco de credito del peru' || strtolower($cuenta->nombre_banco) == 'banco de credito' || strtolower($cuenta->nombre_banco) == 'banco de crédito bcp'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/logobcp.jpg" width="50" class="mr-2 p-1 img-fluid">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'interbank' || strtolower($cuenta->nombre_banco) == 'banco interbank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/interbank.jpg" width="50" class="mr-2 p-1 img-fluid">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'bbva' || strtolower($cuenta->nombre_banco) == 'BBVA CONTINENTAL' || strtolower($cuenta->nombre_banco) == 'bbva - banco continental' || strtolower($cuenta->nombre_banco) == 'banco bbva'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bbva.jpg" width="50" class="mr-2 p-1 img-fluid">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'banco de la nacion' || strtolower($cuenta->nombre_banco) == 'nacion' || strtolower($cuenta->nombre_banco) == 'banco de la nación' || strtolower($cuenta->nombre_banco) == 'banco nación'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bc_nacion.jpg" width="50" class="mr-2 p-1 img-fluid">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'scotiabank' || strtolower($cuenta->nombre_banco) == 'banco scotiabank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/scotiabank.png" width="50" class="mr-2 p-1 img-fluid">
				';
			}
				...
				<div class="masthead">
					...
					<div class="header-main">
						<div class="col-3 col-lg-3">
							<img src="'.$img_logo.'" '.$style_logo.'>
							<h3 class="font-weight-light text-primary mt-3">'.$contribuyente->nombre_comercial.'</h3>
							<p>R.U.C.: '.$contribuyente->ruc.'</p>
							<p>'.$sucursal->direccion.'</p>
							<p>'.$ubigeo_ubicacion.'</p>
							<p><i class="flaticon-call text-primary mr-2"></i>Telf.: '.$sucursal->telefono.'</p>
						...
						<div class="pl-3 col-7 col-lg-7">
							<h4 class="pt-2 font-weight-light text-uppercase" style="line-height: 1.5">COTIZACIÓN: <br> <span  class="bg-primary text-white mt-2">'.$this->zero_fill($documento->numero_comprobante, 6).'</span></h4> 
							<div id="date_invoice">
				...
				<div class="table-invoice mt-2 pt-2">
					<table class="table-main-head mt-3">
						<tbody>
							...
							<tr>
								<td colspan="6" class="text-uppercase">'.$documento->total_letras.' '.strtoupper($sunatmoneda->nombre).'</td>
							</tr>
						</tbody>
					</table>
					<div class="invoice-total">
						<div class="info-total mt-3">
							'.$nota_doc.'
						</div>
					...
					<div class="sub-footer">
						<div class="col-8">
							<div class="single-footer-wight box-main pr-2">
								<img src="'.$ruta_qr.'" width="80px" class="float-left mr-3 mt-3 mb-3">
								<p class="mb-1 mt-3"><span class="text-primary font-weight-bold">Consulte su documento electrónico en:</span> '.$ruta_consulta_documento.'</p>
								<p><span class="text-primary font-weight-bold">VENDEDOR: </span> '.$vendedor->nombre.' '.$vendedor->apellido.' (cod: '.$vendedor->idusuario.')</p>
								<p class="mb-3">Representación Impresa de la Factura Electrónica</p>
								'.$aviso_texto_pruebas.'
	...
	public function get_html_plantilla_a4_5($data) {
		...
		if(!empty($documento->nota)) {
			$nota_doc = '
			<h4 class="text-theme-default text-right font-weight-bold">Observación:</h4>
			<p>'.$documento->nota.'</p>
			';
			$margin_top = 'mt-5';
		} else {
		...
		<body>
			...
			<div class="masthead">
				...
				<div class="invoice-number">
					<h5 class="text-white text-uppercase font-weight-bold" style="font-size:18px!important;">COTIZACIÓN: '.$this->zero_fill($documento->numero_comprobante, 6).'</h5>
				</div>
			</div>
	...
	public function get_html_plantilla_a4_7($data) {
		...
		foreach($lista_cuentas as $cuenta) {
			...
			//Icon de banco 
			if(strtolower($cuenta->nombre_banco) == 'bcp' || strtolower($cuenta->nombre_banco) == 'bcp peru' || strtolower($cuenta->nombre_banco) == 'banco de credito del peru' || strtolower($cuenta->nombre_banco) == 'banco de credito' || strtolower($cuenta->nombre_banco) == 'banco de crédito bcp'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/logobcp.jpg" width="50"  class="img-cuenta">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'interbank' || strtolower($cuenta->nombre_banco) == 'banco interbank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/interbank.jpg" width="50"  class="img-cuenta">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'bbva' || strtolower($cuenta->nombre_banco) == 'BBVA CONTINENTAL' || strtolower($cuenta->nombre_banco) == 'bbva - banco continental' || strtolower($cuenta->nombre_banco) == 'banco bbva'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bbva.jpg" width="50"  class="img-cuenta">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'banco de la nacion' || strtolower($cuenta->nombre_banco) == 'nacion' || strtolower($cuenta->nombre_banco) == 'banco de la nación' || strtolower($cuenta->nombre_banco) == 'banco nación'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bc_nacion.jpg" width="50"  class="img-cuenta">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'scotiabank' || strtolower($cuenta->nombre_banco) == 'banco scotiabank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/scotiabank.png" width="50"  class="img-cuenta">
				';
			}
				...
				<footer class="mt-5 pt-5" style="margin-top: 3em">
					<div class="codigo-qr mb-2">
						<div class="single-footer-wight mt-3 box-main">
							...
							<p class="mb-1 mt-3"><span class="text-theme-default font-weight-bold">Consulte su documento electrónico en:</span></p>
	...
	public function get_html_plantilla_a4_8($data) {
		...
		foreach($lista_cuentas as $cuenta) {
			...
			//Icon de banco 
			if(strtolower($cuenta->nombre_banco) == 'bcp' || strtolower($cuenta->nombre_banco) == 'bcp peru' || strtolower($cuenta->nombre_banco) == 'banco de credito del peru' || strtolower($cuenta->nombre_banco) == 'banco de credito' || strtolower($cuenta->nombre_banco) == 'banco de crédito bcp'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/logobcp.jpg"  width="40px" class="img-cuenta mr-2">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'interbank' || strtolower($cuenta->nombre_banco) == 'banco interbank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/interbank.jpg"  width="40px" class="img-cuenta mr-2">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'bbva' || strtolower($cuenta->nombre_banco) == 'BBVA CONTINENTAL' || strtolower($cuenta->nombre_banco) == 'bbva - banco continental' || strtolower($cuenta->nombre_banco) == 'banco bbva'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bbva.jpg"  width="40px" class="img-cuenta mr-2">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'banco de la nacion' || strtolower($cuenta->nombre_banco) == 'nacion' || strtolower($cuenta->nombre_banco) == 'banco de la nación' || strtolower($cuenta->nombre_banco) == 'banco nación'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/bc_nacion.jpg"  width="40px" class="img-cuenta mr-2">
				';
			} else if(strtolower($cuenta->nombre_banco) == 'scotiabank' || strtolower($cuenta->nombre_banco) == 'banco scotiabank'){
				$img_logo_banco = '<img src="https://arpsystem.com.pe/facturacionv8/img/reporte_plantilla/scotiabank.png"  width="40px" class="img-cuenta mr-2">
				';
			}

			$html_cuentas_corrientes = $html_cuentas_corrientes.'
				<p class="text-uppercase font-weight-bold mt-1">TITULAR: '.$cuenta->nombre_titular.'</p>
				<p>'.$tipo_cuenta_banco.'</p>
				<p>'.$img_logo_banco.' '.$cuenta->nombre_banco.' - SOLES: N° '.$cuenta->nro_cuenta.'.<span class="font-weight-bold"> CCI:</span> '.$cuenta->cci.'</p>
			';
		}
		//Datos del vendedor
		...
		<body>
			...
			<div class="masthead w-100">
				...
				<div class="tabla-head ml-3">
					<table class="table-head table">
						...
						<tr class="bg-main">
							<td  class="text-center bg-theme-default font-weight-bold text-uppercase">COTIZACIÓN</td>
						</tr>
						<tr>
			...
			<footer class="mt-5">
				<div class="col-8 footer-info">
					...
					<p>'.$ruta_consulta_documento.' - Hash: '.$documento->hash_cpe.'
