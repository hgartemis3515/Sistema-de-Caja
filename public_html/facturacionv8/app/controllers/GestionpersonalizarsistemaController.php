...
class GestionpersonalizarsistemaController extends ControllerBase
{
    public function indexAction() {
		$this->setTitle('Gestión diseño Personalizado');
        ...
        $this->assets
            ...
            ->addJs($this->baseUri . "public/js/gestionpersonalizarsistema.js?i=".rand()); 
        ...
        public function get_colorAction(){
        ...
        public function deshacer_disenoAction(){
            $this->view->disable();
            $request = $this->request;
            if($request->isAjax() == true){
                $datapost = $this->request->getPost();
